...
/**
 * Import a batch of hand-vetted mnemonics into data/curated.json.
 *
 *   node scripts/import-curated.mjs <batch-file>
 *
 ...
 *
 * Then run build-words.mjs — importing alone changes nothing the app can show.
 */
...
const jsonPath = resolve(here, '../data/curated.json');
const corpusPath = resolve(here, '../data/corpus.json');

const batchFile = process.argv[2];
if (!batchFile) throw new Error('Usage: node scripts/import-curated.mjs <batch-file>');

/** @type {Record<string, {meaning?: string, hindiMeaning?: string, mnemonic: string}>} */
